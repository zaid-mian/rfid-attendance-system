...
export function getStats() {
  const students = [
    ...
    { uid: "B490F804", name: "Nimra Iman",           rollNo: "2023-AG-10131" },
    { uid: "7AB443B4", name: "Ali Hammad Subhnai",  rollNo: "2023-AG-10035" }
  ];
  ...
  return students.map(student => ({
    ...student,
    present: todayRecords.some(r => r.uid === student.uid),
    time: todayRecords.find(r => r.uid === student.uid)?.time || "-"
  }));
}
